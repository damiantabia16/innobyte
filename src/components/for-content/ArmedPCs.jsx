...
import pc from '../objects/Products.json';
...
const ArmedPCs = () => {
  ...
  return (
    <div id="armed-pcs">
      <div id="armed-pcs-container" className='max-w-[1050px] m-auto'>
        <div id="armed-pcs-title" className='flex items-center'>
          <h2 className='italic font-bold text-[23px] md:pl-[20px] 2xl:pl-0'>ELEGÍ TU PC IDEAL PARA JUGAR</h2>
          <Link to='/pc-armadas' className='ml-[30px]'>
            <span className='hidden md:inline-block text-[#0F52BA] font-bold'>VER PC's</span>
          </Link>
        </div>
        <div id="armed-pcs-column">
