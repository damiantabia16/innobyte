...
import notebook from '../objects/Products.json';
...
const Notebooks = () => {
  ...
  return (
    <div id="notebooks" className='pt-[60px]'>
      <div id="notebook-container" className='max-w-[1050px] m-auto'>
        <div id="notebook-title" className='flex items-center'>
          <h2 className='italic font-bold text-[23px] md:pl-[20px] 2xl:pl-0'>DESCUBRÍ TU NOTEBOOK FAVORITA</h2>
          <Link to='/notebooks' className='ml-[30px]'>
            <span className='hidden md:inline-block text-[#0F52BA] font-bold'>VER NOTEBOOKS</span>
          </Link>
        </div>
        <div id="notebook-column">
